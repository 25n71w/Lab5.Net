...
namespace Lab5.NET.Pages.AnswerImages
{
    public class CreateModel : PageModel
    {
       ...
       // private readonly BlobServiceClient _blobServiceClient;
        ...
        public CreateModel(Lab5.NET.Data.AnswerImageDataContext context, BlobServiceClient blobServiceClient)
        {
            _context = context;
        ...
        [BindProperty]
        public AnswerImage AnswerImages { get; set; }
